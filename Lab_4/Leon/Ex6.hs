...
propSymClosContained relation = all (\x -> elem x (symClos relation)) relation
...
propTransitivity relation = all (\x -> elem x relation) (relation @@ relation)
...
propTrClosContained relation = all (\x -> elem x (trClos relation)) relation
